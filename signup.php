                ...
                <div class="col-md-5 signup_colum_form">
                    ...
                    <form action="">
                        ...
                        <div class="form-row  no-gutter">
                            ...
                            <input class="SignupInput" type="email" name="firstName" id="loginEmail" class="form-control" placeholder="First Name">
                            </div>
                        </div>

                        <div class="form-row  no-gutter">
                            <div class="col-md-7 col_inputDiv">  
                            <input class="SignupInput" type="email" name="LastName" id="loginEmail" class="form-control" placeholder="lastname">
                            </div>
                        </div>
                        <div class="form-row  no-gutter">
                            <div class="col-md-7 col_inputDiv">  
                        ...
                        <div class="form-row   no-gutter">
                            <div class="col-md-7 col_inputDiv">
                            <input  class="SignupInput" type="password" id="loginpassword" name="password" class="form-control" placeholder="Password">
                            </div>
                        </div>

                        <div class="form-row   no-gutter">
                            <div class="col-md-7 col_inputDiv">
                            <input  class="SignupInput" type="password" id="loginpassword" name="confirm_password" class="form-control" placeholder="Confirm Passwords">
                            </div>
                        </div>

                        <div class="form-row no-gutter">
                            <div class="col-md-7">
                                <button type="button" name="btnSignup" class="btnlogin"> Signup</button>
                            </div>
                        </div>
